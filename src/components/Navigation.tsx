  ...
  return (
    <>
      ...
      >
        ...
        <List sx={{ px: isExpanded ? 2 : 1, flex: 1 }}>
          ...
          <Tooltip title={!isExpanded ? "All Cargoes" : ""} placement="right">
            <ListItem
              button
            ...
            >
              ...
              {isExpanded && <ListItemText primary="All Cargoes" />}
            </ListItem>
          </Tooltip>
        ...
        <Box sx={{ p: isExpanded ? 2 : 1, borderTop: `1px solid ${alpha(theme.palette.divider, 0.1)}` }}>
